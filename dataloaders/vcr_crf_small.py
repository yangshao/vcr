...
class VCR(Dataset):
    def __init__(self, split, only_use_relevant_dets=True, add_image_as_a_box=False, embs_to_load='bert_da'):
        self.split = split
        ...
        with open(os.path.join(config.VCR_ANNOTS_DIR, '{}.jsonl'.format(split)), 'r') as f:
    ...
    def __getitem__(self, index):
        ...
        unique_questions = [questions_tokenized[0].tokens]
        # ids = batch_to_ids(unique_questions)
        # question_elmo_embs = self.elmo(ids)
        # instance_dict['ques_rep'] = question_elmo_embs
